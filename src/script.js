...
const wallColorTexture = textureLoader.load(
  "/wall/rough_wood_1k/rough_wood_diff_1k.jpg"
);
const wallARMTexture = textureLoader.load(
  "/wall/rough_wood_1k/rough_wood_arm_1k.jpg"
);
const wallNormalTexture = textureLoader.load(
  "/wall/rough_wood_1k/rough_wood_nor_gl_1k.jpg"
);
...
// Rotate textures by 90 degrees (π/2 radians)
const rotationAngle = Math.PI / 2;

// Set the rotation center to the middle of the texture
wallColorTexture.center.set(0.5, 0.5);
wallARMTexture.center.set(0.5, 0.5);
wallNormalTexture.center.set(0.5, 0.5);

// Apply rotation
wallColorTexture.rotation = rotationAngle;
wallARMTexture.rotation = rotationAngle;
wallNormalTexture.rotation = rotationAngle;
...
// Rotate textures by 90 degrees (π/2 radians)
const roofRotationAngle = Math.PI * -0.04;
...
// Apply rotation
roofColorTexture.rotation = roofRotationAngle;
roofARMTexture.rotation = roofRotationAngle;
roofNormalTexture.rotation = roofRotationAngle;
...
for (let i = 0; i < 30; i++) {
  ...
  grave.position.x = x;
  grave.position.y = Math.random() * 0.44;
  grave.position.z = z;
